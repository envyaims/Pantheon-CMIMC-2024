...
from criminal import BaseCriminal, RandomCriminal, BetterCriminal
from student import BaseStudent, RandomStudent, PrunedStudent, PrunedStudent1, GreedyStudent, GreedyStudentShallow
...
if __name__ == "__main__":
    for i in range(ITERATION):
        ...
        if i % 3 == 0:
            criminals = [("Better Criminal #1", BaseCriminal), ("Random Criminal #1", RandomCriminal)]
            students = [("Pruned v3", BaseStudent), ("Greedy v2 #1", GreedyStudent), ("Greedy v2 #2", GreedyStudent), ("Pruned v2", PrunedStudent1), ("Pruned v1", PrunedStudent), ("Greedy v1 #3", GreedyStudentShallow), ("Greedy v1 #4", GreedyStudentShallow), ("Random Student #2", RandomStudent)]
        elif i % 3 == 1:
            criminals = [("Better Criminal #1", BaseCriminal), ("Random Criminal #1", RandomCriminal)]
            students = [("Pruned v3", BaseStudent), ("Greedy v2 #1", GreedyStudent), ("Greedy v2 #2", GreedyStudent), ("Pruned v2", PrunedStudent1), ("Pruned v1", PrunedStudent), ("Greedy v1 #3", GreedyStudentShallow), ("Greedy v1 #4", GreedyStudentShallow), ("Random Student #2", GreedyStudent)]
        elif i % 3 == 2:
            criminals = [("Better Criminal #1", BaseCriminal), ("Random Criminal #1", RandomCriminal)]
            students = [("Pruned v3", BaseStudent), ("Greedy v2 #1", GreedyStudent), ("Greedy v2 #2", GreedyStudent), ("Pruned v2", PrunedStudent1), ("Pruned v1", PrunedStudent), ("Greedy v1 #3", GreedyStudentShallow), ("Greedy v1 #4", GreedyStudentShallow), ("Random Student #2", RandomStudent)]
        ...
        for student, score in student_scores.items():
            ...
            scores[student] = scores.get(student, 1) + (score / ITERATION)
    ...
    print()
    print("--------------------------------")
    print("Student Leaderboard (Overall, Arithmetic Mean)")
