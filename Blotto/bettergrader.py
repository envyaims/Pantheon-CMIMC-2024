...
from strategy import strategyLocal
from strategy import BaseSoldier
import random
...
class BlottoSwarmGrader:
    ...
    def grade(self, strategy1, strategy2):
        ...
        for game_num in range(1, self.num_games+1):
            ...
            soldiers = [BaseSoldier() for _ in range(BlottoSwarmGame.NUM_SOLDIERS)]
            for _ in range(self.NUM_DAYS):
                ...
                for team, strategy in enumerate([strategy1, strategy2]):
                    for i in range(BlottoSwarmGame.NUM_SOLDIERS):
                        ...
                        try:
                            if team == 0:
                                move = strategyLocal(ally, enemy, offset, soldiers[i])
                            else:
